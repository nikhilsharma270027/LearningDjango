...
SECRET_KEY = 'django-insecure-^jx8e(jz0$(e!ocgr7pe5ksd9b6b=$wq#9fbfh6a2+gb-pe2ax'
...
TEMPLATES = [
    {
        ...
        # Ensure that the templates directory is correctly set
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')] # changed made by me

# if i want to storage images
MEDIA_URL = '/media/'
